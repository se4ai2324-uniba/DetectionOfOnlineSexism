...
accuracy, precision, recall, f1 = evaluation_metrics(x1_val, y1_val, pipe_category)
mlflow.start_run()
mlflow.log_metric("accuracy_val_B", accuracy)
mlflow.log_metric("precision_val_B", precision)
mlflow.log_metric("recall_val_B", recall)
mlflow.log_metric("f1_val_B", f1)
mlflow.end_run()
